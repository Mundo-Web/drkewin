                    ...
                    <table id="tabladatos" class="display text-lg" style="width:100%">
                        ...
                        <tbody>
                            ...
                            @foreach ($slides as $item)
                                <tr>
                                    <td class="line-clamp-3 text-wrap">{{ $item->title }}</td>

                                    <td class="px-3 py-2"><img class="w-32  rounded-md aspect-[16/9]"
                                            src="{{ asset($item->image) }}"></td>
                                    <td>
                                    ...
                                    <td class="flex flex-row justify-end items-center gap-5">
                                        ...
                                        <a href="{{ route('slides.edit', $item) }}"
                                            class="bg-yellow-400 px-3 py-2 rounded text-white  "><i
                                                class="fa-regular fa-pen-to-square"></i></a>
                                        {{-- {{  route('slides.destroy', $item->id) }} --}}
        ...
        $('document').ready(function() {
            ...
            $('#tabladatos').on('click', '.btn_delete', function(e) {
                ...
                Swal.fire({
                    ...
                    text: "Vas a eliminar este slide",
                    icon: "warning",
