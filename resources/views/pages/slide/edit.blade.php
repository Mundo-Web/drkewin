                    ...
                    <div class="rounded shadow-lg p-4 px-4 ">
                        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                            <div class="md:col-span-5">
                                <label for="title">Titulo de slide <span class="text-red-500">(Poner en * * las
                                        palabras que quiere resaltar)</span></label>
                                <div class="relative mb-2 ">
                                    ...
                                    <input type="text" id="title" name="title" value="{{ $slides->title }}"
                                        ...
                                        placeholder="Ej. Explore una *atención personalizada*" required>
                                </div>
                            </div>


                            <div class="md:col-span-5">
                                <label for="description">Descripción de slide</label>
                                <div class="relative mb-2 mt-2">
                                    <textarea type="text" rows="2" id="description" name="description"
                                        class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="Descripción" required>{{ $slides->description }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="md:col-span-5">
                                <label for="description">Imagen actual del slide </label>
                                <div class="relative mb-2 mt-2">
                                    <img src="{{ asset($slides->image) }}"
                            ...
                            <div class="md:col-span-5">
                                ...
                                <div class="relative mb-2  mt-2">
                                    ...
                                    <input type="text" id="btn_text" name="btn_text" value="{{ $slides->btn_text }}"
                                        class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="Titulo">
                                </div>
                            </div>
                            <div class="md:col-span-5">
                                <label for="btn_link">Link del botón</label>
                                <div class="relative mb-2 mt-2">
                                    <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                        <i class="fa-regular fa-pen-to-square"></i>
                                    </div>
                                    <textarea type="text" rows="2" id="btn_link" name="btn_link" value=""
                                        class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="Primer beneficio">{{ $slides->btn_link }}</textarea>
                                </div>
                            </div>
