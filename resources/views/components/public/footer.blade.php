<footer class="bg-bgAzul font-outfit text-textWhite">
    <div class="w-11/12 md:max-w-6xl mx-auto flex flex-col gap-10 pt-12 "> {{-- py-12 --}}
            ...
            <div class="flex flex-col gap-5 basis-1/3">
                <div class="flex flex-col gap-3">
                    ...
                    <p class="font-normal text-text14 xl:text-text18 w-full">
                        Es un especialista en cirugía del aparato digestivo orientado a tratar problemas de vesícula
                        biliar, hernias de la pared abdominal y obesidad.
                    </p>
                </div>
                ...
                <div class="flex flex-col gap-5">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="font-normal text-text14 xl:text-text18 py-2">
                            ...
                            <p>Dirección : <a target="_blank"
                                    href=" https://goo.gl/maps/tfQC3HLLDxBCLCva6
                                ">Av.
                                    Brasil 831</a> </p>
                        ...
                        <div class="font-normal text-text14 xl:text-text18 py-2">
                            ...
                            <p>Dirección: <a target="_blank" href="https://g.co/kgs/qT97oP">Av. Eloy Espinoza 700</a>
                            </p>
