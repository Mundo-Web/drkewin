...
@section('content')
    <main class="flex flex-col gap-10 mb-10 bg-white font-outfit">
        ...
        <div class="bg-white">
            <!-- Sección Principal -->
            <section class="pt-6 pb-6 bg-white mt-4 md:mt-10 w-11/12 mx-auto">
                <!-- Imagen del Doctor -->
                    <img
                            src="{{asset($post->url_image)}}"
                            alt="{{$post->title}}"
                            class="w-full lg:w-1/2 min-h-[500px] object-cover rounded-xl float-left lg:mr-6 mb-4"
                            loading="lazy"
                    />
                <!-- Contenido Principal -->
                <div >
            ...
            <section class="py-6 md:py-12 bg-bgRosa pt-6 pb-6 mt-4 md:mt-10 w-11/12 mx-auto">
                        ...
                        @foreach($otherPosts as $post)
                            <div class="bg-bgWhiteWeak rounded-xl shadow-md overflow-hidden">
                                ...
                                <div class="p-4">
                                    ...
                                    <a href="{{route('detalle-post',$post->slug)}}" class="block text-center bg-bgCeleste text-white font-bold px-6 py-3 rounded-md hover:bg-bgCelesteStrong transition w-full">
                                        Leer más
                                    </a>
                                </div>
                            </div>
