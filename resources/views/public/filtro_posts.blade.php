    ...
    @foreach ($posts as $post)
        <div class="bg-bgRosa rounded-xl shadow-md overflow-hidden">
                              ...
                              <div class="p-4">
                                  ...
                                  <a href="{{route('detalle-post',$post->slug)}}" class="block bg-bgCeleste text-white font-bold px-6 py-3 rounded-md hover:bg-bgCelesteStrong transition w-full text-center ">
                                      Leer más
                                  </a>
                              </div>
                          </div>
